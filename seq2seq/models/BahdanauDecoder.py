...
#         super(BahdanauDecoder, self).__init__(vocab_size, max_len, hidden_size,
...
class BahdanauHierarchicalDecoder(nn.Module):
    def __init__(self, hidden_size, output_size, n_layers=1, drop_prob=0.1):
        super(BahdanauHierarchicalDecoder, self).__init__()
